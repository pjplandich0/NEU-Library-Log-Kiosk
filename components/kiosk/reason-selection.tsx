        ...
        <Card className="max-w-[1000px] w-full bg-white/80 backdrop-blur-3xl border-none shadow-[0_32px_64px_-12px_rgba(0,0,0,0.08)] rounded-[3rem] p-12 md:p-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            {reasons.map((reason) => (
              ...
              >
                <div className="w-20 h-20 bg-slate-50 rounded-full flex items-center justify-center mb-10 group-hover:bg-primary/5 transition-colors">
                  <reason.icon className="w-10 h-10 text-[#6C757D] group-hover:text-primary transition-colors" />
                </div>
